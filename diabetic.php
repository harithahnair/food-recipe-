  ...
  <div>
    ...
    <div id="section">
      <ul>
        ...
        <li  class="selected"><a href="diabetic.php">diebetics</a></li>
        <li><a href="occation.php">occasions</a></li>
        <li><a href="#">cupcakes</a></li>
        <li><a href="#">fondant cakes</a></li>
        <li><a href="#">swiss roll</a></li>
        <li><a href="#">other desserts</a></li>
      </ul>
      <a href="#"><img src="images/dia.jpg" alt="" width="700"></a> </div>
  </div>
</div>
<div id="content">
  <div>
